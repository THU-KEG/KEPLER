...
from fairseq.data import indexed_dataset, BertDictionary
...
def main(args):
    ...
    if args.joined_dictionary:
        ...
        if args.srcdict:
            ...
            assert args.trainpref, "--trainpref must be set if --srcdict is not specified"
            if args.bert:
                print("| Warning: Use BERT dictionary!")
                src_dict = BertDictionary()
            else:
...
def cli_main():
    ...
    parser.add_argument('--bert', action='store_true', help='Use bert dictionary')
